...
def crypto_price(crypto):
    if crypto in cryptocompare.get_coin_list(format=True):
    ...
    elif crypto not in cryptocompare.get_coin_list(format=True):
        return f':no_entry_sign: CURRENCY NOT FOUND, TRY AGAIN. :no_entry_sign:\n:white_check_mark:CORRECT SYNTAX IS ' \
               f'!crypto [CRYPTO TICKER]:white_check_mark:\n' \
